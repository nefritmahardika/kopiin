...
<section class="checkout-orders">
   ...
   <h3>your orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>city :</span>
            <input type="text" name="city" placeholder="e.g. Bandung" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>state :</span>
            <input type="text" name="state" placeholder="e.g. Jawa Barat" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>country :</span>
